...
if($_GET['action'] == 'export') {
    ...
    $template_content->set('content',$script.'<div style="width: 500px; float: left;" id="status"></div><div style="float: left; margin: 5px 0 0 10px; font-weight: bold;" id="status_percent"></div><a class="btn btn-success" style="display: none" id="download_button"><i class="icon-download-alt icon-white"></i> Download</a>');
