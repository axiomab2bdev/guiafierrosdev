...
if(!isset($_GET['action'])) {
    ...
    $form->addField('user_limit','text',array('label'=>$PMDR->getLanguage('admin_products_pricing_user_limit'),'fieldset'=>'product_pricing_details','value'=>'0','help'=>$PMDR->getLanguage('admin_products_pricing_help_user_limit')));
