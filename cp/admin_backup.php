...
$PMDR->loadLanguage(array('admin_backup'));
...
$template_content->set('license',md5(LICENSE));
$template_content->set('files',$table_list->render());

// Setup the menu to display other links and useful information
$template_page_menu = $PMDR->getNew('Template',PMDROOT_ADMIN.TEMPLATE_PATH_ADMIN.'blocks/admin_backup_menu.tpl');
$template_page_menu->set('total_filesize',$total_filesize);
$template_page_menu->set('latest_backup',($latest_backup > 0) ? $PMDR->get('Dates')->formatTimeStamp($latest_backup,true) : '-');
