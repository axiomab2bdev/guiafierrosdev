...
if($form->wasSubmitted('submit')) {
    ...
    if(!$form->validate()) {
        ...
        if($user) {
            ...
            $PMDR->get('Email_Templates')->send('admin_password_reset_request',array('to'=>$user['user_email'],'variables'=>array('admin_password_reminder_url'=>BASE_URL_ADMIN."/admin_password_reset.php?id=$user[id]&verify=".md5(LICENSE.$user['user_email'])),'user_id'=>$user['id']));
        }
