...
if(!isset($_GET['action'])) {
    ...
    $form->addField('type','select',array('label'=>'Type','options'=>array('input'=>$PMDR->getLanguage('admin_settings_custom_input'),'textarea'=>$PMDR->getLanguage('admin_settings_custom_textarea'),'checkbox'=>$PMDR->getLanguage('admin_settings_custom_checkbox'))));
