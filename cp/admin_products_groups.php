...
if(!isset($_GET['action'])) {
    ...
    $form->addField('user_limit','text',array('label'=>$PMDR->getLanguage('admin_products_groups_user_limit'),'fieldset'=>'group_details','help'=>$PMDR->getLanguage('admin_products_groups_user_limit_help')));
