...
foreach($records as $key=>$record) {
    ...
    if(!empty($trace)) {
        foreach($trace AS $trace) {
            $trace_output .= '<strong>File</strong>: '.$trace['file'].'<br />';
            $trace_output .= '<strong>Line</strong>: '.$trace['line'].'<br />';
            if(isset($trace['function'])) {
                $trace_output .= '<strong>Function</strong>: '.$trace['function'].'<br />';
            }
            if(isset($trace['class'])) {
                $trace_output .= '<strong>Class</strong>: '.$trace['class'].'<br />';
            }
            $trace_output .= '<br />';
        }
    }
