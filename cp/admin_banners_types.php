...
if(!isset($_GET['action'])) {
    ...
    foreach($records as &$record) {
        ...
        <div id="banner_type_code'.$record['id'].'" style="margin-top: 5px; display: none;">
            ...
            <input type="text" class="code span9" readonly="readonly" value="'.$PMDR->get('Cleaner')->clean_output('<?php echo $PMDR->get(\'Banner_Display\')->getBanner('.$record['id'].'); ?>').'">
            <br /><br />
            <p><strong>'.$PMDR->getLanguage('admin_banners_types_remote_code').':</strong></p>
            <textarea class="code span9" readonly="readonly" style="height: 55px;"><script type="text/javascript" src="'.BASE_URL.'/remote_banner.php?type='.$record['id'].'"></script></textarea>
        </div>
        ';
