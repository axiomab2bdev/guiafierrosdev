...
<table border="0" cellpadding="3" cellspacing="0">
 <tr>
  <td>
    ...
    <input style="width: 150px" type="text" name="keyword" size="20" maxlength="64">&nbsp;';
    $output_cat.= '<select name="category">';
...
$output_cat .= '&nbsp;<input class="btn" type="submit" name="submit" value="'.$PMDR->getLanguage('admin_submit').'">
     </td>
    </tr>
   </table>
  </td>
...
<table border="0" cellpadding="3" cellspacing="0">
 <tr>
  <td>
    ...
    <tr>
        <td><input style="width: 150px" type="text" name="keyword" size="20" maxlength="64"></td>
        <td><input style="width: 150px" type="text" name="zip" size="20" maxlength="64"></td>
        <td><input class="btn" type="submit" name="submit" value="'.$PMDR->getLanguage('admin_submit').'"></td>
    </tr>
   </table>
  </td>
 </tr>
