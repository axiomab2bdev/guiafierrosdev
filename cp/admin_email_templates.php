...
if(!isset($_GET['action'])) {
    ...
    if(isset($_GET['filter'])) {
        ...
        } elseif(in_array($_GET['filter'],array('general','invoice','listing','order','review','user'))) {
    ...
    foreach($records as &$record) {
        ...
        if(strstr($record['id'],'admin_')) {
            ...
            $record['name'] .= ' <span class="label pull-right">Administrator</span>';
    ...
    if($_GET['action'] == 'edit') {
        ...
        $template_page_menu[] = array('title'=>$PMDR->getLanguage('admin_email_templates_variables'),'content'=>$PMDR->get('Email_Templates')->getVariablesTemplate($template['id'],$template['type']));
