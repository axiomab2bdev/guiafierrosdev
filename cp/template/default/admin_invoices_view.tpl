        ...
        <div class="tab-pane active" id="tab1">
            <div class="row">
                    ...
                    <table class="table table-bordered table-condensed">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php } else { ?>
                                    <span class="label label-important"><?php echo $balance_formatted; ?></span>
                                <?php } ?>
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="span9" style="text-align: center">
                    <p>
                        <span class="label label-<?php if($status == 'unpaid') { ?>warning<?php } elseif($status == 'paid') { ?>success<?php } ?> label-xlarge"><?php echo $lang['admin_invoices_'.$status]; ?></span>
                    </p>
                    <p>
                        <a class="btn" href="JavaScript:newWindow('admin_invoices.php?action=print&id=<?php echo $id; ?>','popup',650,600,'')"><i class="icon-print"></i> <?php echo $lang['admin_invoices_print']; ?></a>
                        <a class="btn" href="admin_invoices.php?action=pdf&id=<?php echo $id; ?>"><i class="icon-file"></i> <?php echo $lang['admin_invoices_download_pdf']; ?></a>
                    </p>
                    <p>
                        <a class="btn btn-success btn-small" href="admin_invoices.php?action=paid&id=<?php echo $id; ?>&user_id=<?php echo $user_id; ?>"><?php echo $lang['admin_invoices_mark']; ?> <?php echo $lang['admin_invoices_paid']; ?></a>
                        <a class="btn btn-warning btn-small" href="admin_invoices.php?action=unpaid&id=<?php echo $id; ?>&user_id=<?php echo $user_id; ?>"><?php echo $lang['admin_invoices_mark']; ?> <?php echo $lang['admin_invoices_unpaid']; ?></a>
                        <a class="btn btn-small" href="admin_invoices.php?action=canceled&id=<?php echo $id; ?>&user_id=<?php echo $user_id; ?>"><?php echo $lang['admin_invoices_mark']; ?> <?php echo $lang['admin_invoices_canceled']; ?></a>
                        <a class="btn btn-danger btn-small" href="admin_invoices.php?action=delete&id=<?php echo $id; ?>&user_id=<?php echo $user_id; ?>"><?php echo $lang['admin_delete']; ?></a>
                    </p>
                    <p>
