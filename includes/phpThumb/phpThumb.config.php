...
$PHPTHUMB_CONFIG['cache_directory'] = $PHPTHUMB_CONFIG['document_root'].'/files/cache/'; // set the cache directory to an absolute directory for all source images
...
$PHPTHUMB_CONFIG['output_format']    = 'gif'; // default output format ('jpeg', 'png' or 'gif') - thumbnail will be output in this format (if available in your version of GD). This is always overridden by ?f=___ GETstring parameter
