...
<div class="container">
	...
	<div class="sixteen columns">
        ...
        <div id="graphics_charts">
			<?php 
			//old data graph function: { '.Measure::model()->dataToObject($objectGraph,$objectSubGraph).' }
			//'.Measure::model()->dataToObjectFormatDate($objectGraph,$objectSubGraph).'
            ?>
          <div id="yw0"></div>
         <script>
		 $(function () {
			...
			$('#yw0').highcharts({
				...
				title: {
					text: '<? if(isset($_POST['object_id_search'])){echo $modelMeasure->title;}else{ echo "Gráfica de Visitas";}?>'
				},
				subtitle: {
    ...
    <div id="tabs">
      ...
      <div id="tabs-1">         
        <table class="tbl_admin" class="table td display responsive no-wrap" width="100%" cellspacing="2">
            <thead>
                <tr>
                	<? if(!isset($_POST['object_id_search'])){?><th></th><? } ?>
                    <th>Nombre</th>
                    <th>Visitas</th>
                    <th>Tipo</th>
                    <th>Paises</th>
