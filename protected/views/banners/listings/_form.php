...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="post-quote create_listing">
        ...
        <div class="columns tree">
            <a href="guia/site/index" id="btn-index" class="btn btn-lg btn-default btn-block">Volver a Inicio</a>
        </div>
    </div>
	<?php }?> 
    ...
    <div class="row">
		<h4>Descripción</h4>
		<?php echo $form->textArea($model,'description',array('rows'=>6, 'cols'=>50, 'class'=>'area-field')); ?>
    ...
    <div class="row">
		...
		<?php echo CHtml::dropDownList('Listings[primary_category_id]','', Categories::getCategoriesArray(), array('id'=>'primary_category_id', 'class'=>'chosen-select-no-single', 'required'=>'required','prompt'=>'Seleccione una Categoría'));
    ?>
      ...
      <h4>Ubicación <span class="required">*</span></h4>
       <div class="row">
       <?php echo CHtml::dropDownList('Listings[location_id]','', Locations::getIdLocationsArray(), array('id'=>'location_id', 'class'=>'chosen-select-no-single', 'required'=>'required','prompt'=>'Seleccione una Ubicación'));
        ?>
    ...
    <div class="row">
    	   <input type="radio" id="terminos" checked="checked"/> Acepto&nbsp;<a href="/terminos-y-condiciones">Términos Condiciones</a> y <a href="/politica-de-datos">Tratamientos de Datos</a>
    </div>
