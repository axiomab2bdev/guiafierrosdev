...
class NewsCategories extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, title, friendly_url, meta_title', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, title, friendly_url, meta_title', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id',$this->list_id,true);
		$criteria->compare('title',$this->cat_id,true);
